...
namespace Systems
{
    ...
    public partial struct ObstacleAvoidanceSystem : ISystem
    {
        ...
        {
            var obstacleAvoidanceMode = SystemAPI.GetSingleton<ObstacleAvoidanceModeSingleton>();
            if (obstacleAvoidanceMode.ObstacleAvoidanceMode != ObstacleAvoidanceMode.Physics)
                return;
